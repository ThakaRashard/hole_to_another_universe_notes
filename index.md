...
<iframe width="100%" height="315" src="https://www.youtube.com/embed/hWitRABYVBk" title="YouTube video player"  allowfullscreen></iframe>
...
You can use the [editor on GitHub](https://github.com/ThakaRashard/hole_to_another_universe_notes/edit/main/README.md) to maintain and preview the content for your website in Markdown files.
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/ThakaRashard/hole_to_another_universe_notes/settings/pages). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
